...
2. 标记整理算法
   ...
   ![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240801232050752.png)
...
3. 复制算法
   ...
   需要两块空间，每次只使用其中一块，将存活对象复制一份到另外一块空间，将原来的对象引用指向新复制的对象

   ![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240801232225877.png)
...
![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240804102839294.png)

> YoungCollection+ConcurrentMark 年轻代垃圾回收+并发标记

- 当老年代占用内存超过阀值（默认是45%）后，触发并发标记，这时无需暂停用户线程

  ![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240804103700821.png)

- 并发标记之后，会有重新标记阶段解决漏标问题，此时需要暂停用户线程。

- 这些都完成后就知道了老年代有哪些存活对象，随后进入混合收集阶段。此时不会对所有老年代区域进行回收，而是根据暂停时间目标优先回收价值高（存活对象少）的区域（这也是 Gabage First 名称的由来）。

![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240804105850635.png)

> Mixed Collection 混合垃圾回收

- 混合收集阶段中，参与复制的有eden、survivor、old

![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240804110114978.png)

- 复制完成，内存得到释放。进入下一轮的新生代回收、并发标记、混合收集

  ![](https://raw.githubusercontent.com/du-mozzie/PicGo/master/images/image-20240804110221856.png)
